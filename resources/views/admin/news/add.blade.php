    ...
    <div class="main-content-inner">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">@if($id==0)Thêm mới @else Sửa @endif bài viết</li>
            </ul>
        </div>
                    ...
                    <form class="form-horizontal paddingTop30" name="txtForm" action="" method="post" enctype="multipart/form-data">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" name="news_catid">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="news_title" value="@if(isset($data['news_title'])){{$data['news_title']}}@endif">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <a href="javascript:;"class="btn btn-primary link-button" onclick="UploadAdmin.uploadMultipleImages(2);">Upload ảnh</a>
                                    <input name="image_primary" type="hidden" id="image_primary" value="@if(isset($data['news_image'])){{trim($data['news_image'])}}@endif">
                                </div>
                                <div class="clearfix"></div>
                                <!--Hien Thi Anh-->
                                <ul id="sys_drag_sort" class="ul_drag_sort mgt10">
                                        ...
                                        @foreach($news_image_other as $k=>$v)
                                            <li id="sys_div_img_other_{{$k}}">
                                                <div class="div_img_upload">
                                                    ...
                                                    <br/>
                                                    <a href="javascript:void(0);" id="sys_delete_img_other_{{$k}}" onclick="UploadAdmin.removeImage('{{$k}}', '{{$data['news_id']}}', '{{$v['img_other']}}', '2');">Xóa ảnh</a>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="controls"><button type="button" onclick="UploadAdmin.getInsertImageContent(2, 'open')" class="btn btn-primary">Chèn ảnh vào nội dung</button></div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="news_order_no" value="@if(isset($data['news_order_no'])){{$data['news_order_no']}}@endif">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" name="news_focus">
                                    {!! $optionFocus !!}
                                </select>
                            </div>
                        </div>
