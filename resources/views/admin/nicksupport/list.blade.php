	...
	<div class="main-content-inner">
		<div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Quản lý nick support</li>
			</ul>
		</div>
			...
			<div class="row">
				<div class="col-xs-12">
						...
						<form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
							<div class="panel-body">
								<div class="form-group col-lg-2">
									...
									<div>
										<input type="text" class="form-control input-sm" name="title" @if(isset($search['title']) && $search['title'] !='')value="{{$search['title']}}"@endif>
									</div>
								</div>
								<div class="form-group col-lg-2">
							...
							<div class="panel-footer text-right">
								<a class="btn btn-danger btn-sm" href="{{FuncLib::getBaseUrl()}}admin/nicksupport/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
					...
					@if(sizeof($data) > 0)
						...
						@endif
						<br>
						<form id="formListItem" method="POST" action="{{FuncLib::getBaseUrl()}}admin/nicksupport/delete" class="formListItem" name="txtForm">
							<table class="table table-bordered table-hover">
								...
								@foreach($data as $k=>$item)
									<tr>
										...
										<td>
											<a href="{{FuncLib::getBaseUrl()}}admin/nicksupport/edit/{{$item['id']}}" title="Cập nhật">
