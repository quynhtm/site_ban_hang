                    ...
                    <form class="form-horizontal paddingTop30" name="txtForm" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control input-sm" name="provice_num" value="@if(isset($data['provice_num'])){{$data['provice_num']}}@endif">
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control input-sm" name="provice_num_gold_ship" value="@if(isset($data['provice_num_gold_ship'])){{$data['provice_num_gold_ship']}}@endif">
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control input-sm" name="provice_num_vnpost" value="@if(isset($data['provice_num_vnpost'])){{$data['provice_num_vnpost']}}@endif">
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
