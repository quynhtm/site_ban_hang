			...
			<div class="row">
				<div class="col-xs-12">
					...
					@if(sizeof($data) > 0)
						...
						@endif
						<br>
						<form id="formListItem" method="POST" action="{{FuncLib::getBaseUrl()}}admin/trash/delete" class="formListItem" name="txtForm">
							<table class="table table-bordered table-hover">
								...
								@foreach($data as $k=>$item)
									<tr>
										...
										<td>
											<label class="pos-rel">
												<input class="ace checkItem" name="checkItem[]" value="{{$item['trash_id']}}" type="checkbox">
												<span class="lbl"></span>
											</label>
										</td>
										...
										<td>
											<a href="{{FuncLib::getBaseUrl()}}admin/trash/edit/{{$item['trash_id']}}" title="Cập nhật">
