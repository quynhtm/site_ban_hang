...
@section('content')
    <div class="container">
        <div class="row">
            <div class="main-box">
                @if(isset($dataBannerNew) && sizeof($dataBannerNew) > 0)
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="line postCatImg">
                            @foreach($dataBannerNew as $k=>$slider)
                                <?php
                                ...
                                ?>
                                <a {{$target}} {{$rel}} href="@if($slider->banner_link != '') {{$slider->banner_link}} @else javascript:void(0) @endif" title="{{$slider->banner_title}}">
                                    <img src="{{ThumbImg::thumbBaseNormal(CGlobal::FOLDER_BANNER, $slider->banner_id, $slider->banner_image, 960, 300, '', true, true, false)}}" alt="{{$slider->banner_title}}" />
                                </a>
                                @if($slider->banner_intro != '')
                                    <div class="desc">
                                        {{$slider->banner_intro}}
                                    </div>
                                @endif
                    ...
                    <div class="sliderLeftPostNews">
                        <ul id="sliderPostNews">
                            ...
                            <li class="line item-post-news">
                                ...
                                <a title="{{$item->news_title}}" href="{{FuncLib::buildLinkDetailNews($item->news_id, $item->news_title)}}">{{$item->news_title}}</a>
                            </li>
                            @endforeach
                        </ul>
                ...
                <div class="col-lg-9 col-md-9 col-sm-8">
                    <div class="line postViewHead headCate">
                        <h1>
                            <span class="block">&nbsp;</span><a title="Hàng mới về" href="{{URL::route('site.pageProductNew')}}">Hàng mới về</a>
                            <div class="type-view">
