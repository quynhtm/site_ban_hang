                           ...
                           @if(sizeof($data) > 0)
                               @foreach($data as $k=>$item)
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 item-post-news">
                                       <h3><a title="{{$item->statics_title}}" href="{{FuncLib::buildLinkDetailStatic($item->statics_id, $item->statics_title)}}">{{$item->statics_title}}</a></h3>
                                       <p class="time">{{date('d/m/Y', $item->statics_created)}}</p>
                                       <p>{!!Utility::cutWord($item->statics_intro, 50, '...')!!}</p>
                                   </div>
                                   @endif
                               @endforeach
                           @endif
